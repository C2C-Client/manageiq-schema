class CreateSecurityPolicy < ActiveRecord::Migration[5.0]
  def change
    ...
    create_table :security_policy_rule_destination_security_groups do |t|
    ...
    create_table :security_policy_rule_source_security_groups do |t|
    ...
    create_table :security_policy_rule_network_services do |t|
